...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < seif.length; i += 2) {
            ...
            switch (kvoE) {
                case "Gem":
                    if (add(torba, broika, kvoE, "Gold")) continue;
                    break;
                case "Cash":
                    if (add(torba, broika, kvoE, "Gem")) continue;
                    break;
            }
    ...
    private static boolean add(LinkedHashMap<String, LinkedHashMap<String, Long>> torba, long broika, String kvoE, String gem) {
        if (!torba.containsKey(kvoE)) {
